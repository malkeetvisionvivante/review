										...
										<tr>
											<td id="header_wrapper">
												<header style="background-color: #85be39;padding: 10px;text-align: left;font-size: 20px;color: white;">
												  <h2 style="margin:0;padding: 0;">Spam Behavior</h2>
												</header>
											</td>
										</tr>
									</table>
													...
													<tr>
														<td valign="top">
															<div id="body_content_inner">
																<h1>Hi, Admin</h1>
																<p>This user added multiple duplicate Colleague. </p>
							...
							<tr>
								<td align="center" valign="top">
									<div class="header" style="overflow: hidden;background-color: #f1f1f1;text-align: center;color: #000000; padding: 20px 10px;">
									  	<span>Copyright @2020</span><span class="agentconnect-color"> Blossom </span><span> All right reserved </span>
									</div>
								</td>
							</tr>
						</table>
