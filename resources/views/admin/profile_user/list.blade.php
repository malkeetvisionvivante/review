...
<div class="card my-3 border-bottom">
    <div class="row p-0 justify-content-between">
        ...
        <div class="col-md-8">
          <form name="serch" action="{{ url('/admin/profile/users/list')}}" method="post">
           @csrf 
            <div class="row p-0">
            <div class="col-md-3">
            ...
            <div class="input-group mb-1">
                ...
                <a href="{{ url('admin/profile/add/users')}}" class="btn btn-success round-shape ml-4">Add Profile</a>
            </div>
            </div>
        </form>
        </div>
     ...
     @if(count($data))   
      ...
      <div class="row p-0">
                    ...
                    <div class="media-left">
                      @if(!empty($datas->profile))
                        <div class="media-img-container p-0">
                            <a href="{{ url('admin/profile/users/detail/'.$datas->id)}}"><img src="{{ asset('images/users/'.$datas->profile)}}" alt="profile" class="img-fluid" /></a>
                        </div>
                         @else
                          <div class="media-img-container">
                             <a href="{{ url('admin/profile/users/detail/'.$datas->id)}}"><img src="{{ asset('images/default/user.png')}}" alt="apple" class="img-fluid" /></a>
                          </div>
                        @endif 
                    </div>
                    <div class="media-body">
                        <a href="{{ url('admin/profile/users/detail/'.$datas->id)}}">
            ...
            <div class="col-md-4 text-right">
                ...
                <a href="{{ url('admin/profile/edit/users/'.$datas->id)}}" class="h6 text-blue"><i class="fas fa-pencil-alt"></i>  Edit</a>
                <a href="{{ url('admin/delete/profile/'.$datas->id)}}" onclick="return confirm('Are You Sure delete Profile Permanently!')" class=" h6 text-blue ml-3"><i class="fas fa-trash"></i> Delete</a>
                @else
                <a href="{{ url('admin/profile/edit/users/'.$datas->id)}}" class="h6 text-blue"><i class="fas fa-pencil-alt"></i>  Edit</a>
                <a href="{{ url('admin/recover/profile/'.$datas->id)}}" onclick="return confirm('Are You Sure Recover Profile!')" class=" h6 text-blue ml-3"><i class="fas fa-trash-restore"></i> Recover</a>
                @endif
            </div>
        </div>
        <!-- <div class="row p-0">
