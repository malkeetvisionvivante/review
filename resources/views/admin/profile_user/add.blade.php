...
<div class="inner-container">
            ...
            <div class="col-md-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb p-0 mb-0 bg-white justify-content-md-end">
                        <li class="breadcrumb-item"><a href="{{ url('admin/profile/users/list')}}" class="text-blue">Profile</a></li>
    ...
    <div class="card">
        <div class="row p-0">
            <div class="col-md-12">
                <form class="mainform" method="post" action="{{ url('admin/profile/add/users')}}" enctype="multipart/form-data">
                 @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" placeholder="Email Address" class="form-control  @error('email') is-invalid @enderror" name="email" value="{{ old('email')}}" autocomplete="off">
                                 @error('email')
                                         <span class="invalid-feedback" role="alert">
                                            <strong>{{$message}}</strong>
                                        </span>
