...
<div class="card my-3 border-bottom">
    <div class="row p-0 justify-content-between">
        ...
        <div class="col-md">
          <form name="search_filter" action="{{ url('admin/department/list')}}" method="get">
            @csrf
  ...
  @foreach($data as $datas)
     <div class="row p-0">
        <div class="col-md-6 order-1 order-md-1">
            <a href=" {{ url('admin/department/detail/'.$datas->id) }}"><h3> {{ $datas->name}} </h3></a>
        </div>
        <div class="col-md-6 order-3 order-md-2 text-right">
            <div class="mb-2">
                <div class="custom-control custom-switch custom-control-inline">
                    ...
                    <a href="{{ url('admin/delete/dept/'.$datas->id)}}" onclick="return confirm('Are You Sure delete department Permanently!')" class="h6 text-blue ml-3"><i class="fas fa-trash"></i> Delete</a>
                </div>
        </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-header border-0">
        <button type="button" class="close px-2 py-1 " data-dismiss="modal">&times;</button>
         ...
         <h4 class="px-4">Update Department</h4>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body px-4">
        ...
        <form class="add-departmanet-form" method="post" action="{{ url('admin/add/newdepartment')}}">
          @csrf
...
@section('scripts')
 <script type="text/javascript">
  ...
  $(document).on('click','.edit_dept',function(){
    var id =  $(this).attr('data-id');
    var url = "{{ url('get_data_department')}}/" + id;
