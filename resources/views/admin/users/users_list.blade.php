...
<div class="card my-3 border-bottom">
    <div class="row p-0 justify-content-between">
        ...
        <div class="col-md-8">
          <form name="serch" action="{{ url('/admin/users/list')}}" method="get">
           @csrf 
            <div class="row p-0">
            <div class="col-md-3">
     ...
     @if(count($data))   
      ...
      <div class="row p-0">
            <div class="col-md-8">
                <div class="media">
                        ...
                        <div class="media-img-container p-0">
                         ...
                         @else
                          <div class="media-img-container">
                             <a href="{{ url('admin/users/detail/'.$datas->id)}}"><img src="{{ asset('images/default/user.png')}}" alt="apple" class="img-fluid" /></a>
                          </div>
                        @endif 
                    </div>
                    <div class="media-body">
                        ...
                        <h6 class="text-muted">Type: {{ $datas->type() }} @if($datas->claimed == 'yes' ) ( claimed ) @endif</h6>
            ...
            <div class="col-md-4 text-right">
                ...
                <a href="{{ url('admin/delete/user/'.$datas->id)}}" onclick="return confirm('Are You Sure delete user!')" class=" h6 text-blue ml-3"><i class="fas fa-trash"></i> Delete</a>
                @else
                <a href="{{ url('admin/edit/users/'.$datas->id)}}" class="h6 text-blue"><i class="fas fa-pencil-alt"></i>  Edit</a>
                <a href="{{ url('admin/recover/user/'.$datas->id)}}" onclick="return confirm('Are You Sure recover user!')" class=" h6 text-blue ml-3"><i class="fas fa-trash-restore"></i> Recover</a>
                @endif
