    ...
    <div class="card">
        <div class="row p-0">
            ...
            <div class="col-md-3 text-right">
                ...
                <a href="{{ url('admin/edit/users/'.$data1->id)}}" class="ml-2 text-blue"><i class="fas fa-user-edit"></i></a>
            </div>
        </div>
        <hr>
...
<script type="text/javascript">
    ...
    jQuery("#review_filter").change(function(e){
        ...
        window.location = "{{ url('admin/users/detail') }}/" + _this.attr("data-id") + "/" + selected;
    })
    ...
    jQuery(".key-trash").click(function(e){
        ...
        if (result) {
            jQuery.ajax({
            type: 'post',
            url: "{{ url('admin/users/remove-single-review') }}",
    ...
    jQuery(".hide-comment").click(function(e){
        ...
        var id = _this.attr('data-id');
            jQuery.ajax({
            type: 'post',
            url: "{{ url('admin/users/hide-review-comment') }}",
    ...
    jQuery(".hide-review").click(function(e){
        ...
        var id = _this.attr('data-id');
            jQuery.ajax({
            type: 'post',
            url: "{{ url('admin/users/hide-review') }}",
            data: { id ,"_token": "{!! csrf_token() !!}" },
            success: function (res) {
                if(res.success){
                        if(res.status == 1){
