@if(Auth::check())
  ...
  <div class="backdrop">
    <div class="onboarding_flow_modal">
      ...
      <div class="step" id="step_2">
        <a href="#" class="btn-back" data-item="2">Back</a>
      ...
      <div class="step" id="step_3">
        <a href="#" class="btn-back" data-item="3">Back</a>
      ...
      <div class="step" id="step_4">
        <a href="#" class="btn-back" data-item="4">Back</a>
      ...
      <div class="step" id="step_5">
        <a href="#" class="btn-back" data-item="5">Back</a>
        @if(Auth::user()->company_id)
        <a href="#" class="btn-next"  data-item="5">Next</a>
        @else
        ...
        <div class="search-box">
         ...
         <!--        <input type="text" name="name" list="company_list" class="form-control search-form-control border-right-0" placeholder="Search companies" id="custom_serach_top1" autocomplete="off"> -->
                <input type="text" placeholder="Search companies" list="company_list" class="form-control search-form-control border-right-0" name="company_name" id="search_company_list" autocomplete="off" value="{{ Auth::user()->companyName(Auth::user()->company_id) }}" >
      ...
      <div class="step" id="step_6">
        <a href="#" class="btn-back" data-item="6">Back</a>
      ...
      <div class="step" id="step_7">
        <a href="#" class="btn-back" data-item="7">Back</a>
  ...
  <script type="text/javascript">
    $('.btn-back').click(function(){
      ...
      var backItem = parseInt(itemId) - 1;
      $("#step_"+itemId).removeClass('active');
      $("#step_"+backItem).addClass('active');
    });
